...
final List<Recommendation> demo_recommendations = [
  ...
  Recommendation(
    ...
    source: "Linkedin",
    text:
        "Rohan is great asset for any organization. It's a true pleasure working with him at TakeIn. His flutter skill is amazing as well as his professionalism and being a good team player. Abu's problem solving skill is also one of his great skills.",
  ),
  Recommendation(
    name: "Diadem",
    source: "YouTube",
